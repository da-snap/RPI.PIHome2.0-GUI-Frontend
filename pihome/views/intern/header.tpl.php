      ...
      <div class="container-fluid">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <?php } ?>
            <li class="dropdown">
              <a href="#" class="dropdown-toggle js-activated" data-toggle="dropdown"><span class="circle_home" style="background-color:<?php echo $userdata['color'];?>;"><?php echo name($userdata['name']); ?></span>   <b class="fa fa-chevron-down"></b></a>
              <ul class="dropdown-menu">
